Motor = new function()
{
	...
	this.desactivar = function() {
		...
		//console.log(Motor.audios);
		for( key1 in  Motor.audios){
		    //console.log(Motor.audios[key1])
            if ( !Motor.audios[key1].bt.paused ){
                //Motor.audios[key1].pressHandler();
    ...
    this.drawTitols = function()
    {
    	...
    	this.ini.graphics.beginFill("#FCDFB6").drawRoundRect(125, this.INITIAL_Y + 6, 775, 30, 5);
		...
		this.titolIni.fontSize = (Contenedor.datosXML.plataforma.grado == 1)?  16 : 14 ;
		this.titolIni.color = "#0D3158";
		this.titolIni.text = Motor.datosXML.orden.ini ;
		this.titolIni.x = 135;
		this.titolIni.y = this.INITIAL_Y + 11 ;
		Main.stage.addChild( this.titolIni);
    	
    	this.fi = new createjs.Shape();
    	this.fi.graphics.beginFill("#FCDFB6").drawRoundRect(125, this.INITIAL_Y + 397, 775, 30, 5);
		...
		this.titolFi.fontSize = (Contenedor.datosXML.plataforma.grado == 1)?  16 : 14;
		this.titolFi.color = "#0D3158";
		this.titolFi.text = Motor.datosXML.orden.fi ;
		this.titolFi.x = 135;
		this.titolFi.y = this.INITIAL_Y + 402;
    ...
    this.drawContenedores = function()
    {
    	...
    	{
    		var base = new BaseElemento(i, 742, this.heightElement+2 , 6);
	        base.contenedor.x = 169 ;
    ...
    this.drawElementos = function()
    {
    	...
    	for(var i=0; i < numElementos; i++)
    	{
	        ...
	        // creem caixa element
	        var el = new Elemento( elemento.contestacion, elemento.orden, 740, this.heightElement, 6) ;
	        el.contenedor.x = 170;
