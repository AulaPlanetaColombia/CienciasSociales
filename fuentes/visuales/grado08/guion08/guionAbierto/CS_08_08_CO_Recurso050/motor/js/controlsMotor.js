...
Resposta.prototype.dibuixa = function() {
	...
	this.text.x = 8;
	this.text.y = 5;
	this.text.lineWidth = this.width - 15;
	this.text.lineHeight = 22;
	this.text.mouseEnabled = false;
	
	this.text.mask = new createjs.Shape();
	this.text.mask.graphics.beginFill("#fff").drawRoundRect(0, 0, this.width-15,  this.height-5, 1);
	this.text.mask.x = 8;
	this.text.mask.y = 5;
...
Pregunta.prototype.dibuixa = function() {
	...
	this.fons = Utils.arrowRect(this.fons, 0, 0, 300, 82);
	...
	this.text.mask = new createjs.Shape();
	this.text.mask.graphics.beginFill("#fff").drawRoundRect(0, 0, 270, 78, 1);
	this.text.mask.x = 8;
	this.text.mask.y = 3;
