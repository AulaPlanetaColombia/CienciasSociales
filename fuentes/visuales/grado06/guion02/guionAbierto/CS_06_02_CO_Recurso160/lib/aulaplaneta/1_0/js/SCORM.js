/************************************************************************
	...
	Versió: 15.3.17.1
	História:	- 17/3/15: Mantenir l'estat correcte de la configuració SCORM
			- 30/9/14: Assimilaci� mode "normal" a "exam" i afegig debugMode
...
if (!aulaPlaneta.hasOwnProperty("SCORM")) {
	...
	aulaPlaneta.SCORM = {
		...
		////////////////////////////////////////////////
		// CONFIGURACION QUE SE ENVIA AL USUARIO
		////////////////////////////////////////////////
		config: {},
		////////////////////////////////////////////////
