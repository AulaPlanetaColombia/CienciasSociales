...
var margenIni=0,margenV=0,web='intelisen',orientacion,isbq,isiPad,ischrome,isSurface,isSamsung;
   var debug=0;
   detectOrientation();
...
function detectOrientation(){
 ...
 var spanTag = document.createElement("span"); 
            ...
            document.body.appendChild(spanTag); 
                 ...
                 isSamsung = ua.match(/es-es; samsung sm-p605/i) != null;
				...
				var isMacbook=ua.match(/macintosh; intel mac os x/i) != null;
...
if (isbq)  detectOrientation();
                ...
                if (isandroid && issafari && !ischrome) {zoom=zoom/1.2;}
					...
					if (isSamsung && orientacion==1) {zoom=zoom/2.62;}
					if (isSamsung && orientacion==0) {zoom=zoom/2;}
					if (isMacbook) {zoom=zoom/window.devicePixelRatio  ;}
